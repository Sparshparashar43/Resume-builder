...
export default function ButtonMUI() {
    return ( <
        ...
        <
        Stack p = {
            { xs: "15px", sm: "25px", md: "40px", lg: "60px " } } >
        <
        h2 className = "template-header-title" > Resume Builder < /h2> <
        Stack className = "midContainer"
        direction = {
            {
                xs: "column-reverse",
                sm: "column-reverse",
        ...
        <
        Instagram sx = {
            { fontSize: "40px", paddingLeft: "15px" } }
        color = "error" /
        >
        <
        /Link>
        ...
        <
        GitHub sx = {
            { fontSize: "40px", paddingLeft: "15px", color: "black" } }
        /> <
        /Link> <
        /Box> <
        /Box> <
