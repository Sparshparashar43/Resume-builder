...
const PersonalInfoComponent = (props) => {
    ...
    return ( <
        Paper className = "personal-info-paper"
        elevation = { 3 } >
        <
        Avatar sx = {
            { width: 120, height: 120, marginBottom: 1 } }
        alt = "profile img"
        src = {
        ...
        DialogContent >
        <
        Avatar1 width = { windowSize.innerWidth > 900 ? 200 : 150 }
        ...
        /> <
        InputComponent title = { "Postal Code" }
        type = { "number" }
        name = { "postalCode" }
        register = { register }
        multiline = { false }
        ...
        /> <
        /div> <
        InputComponent title = { "Objective" }
        type = { "text" }
        name = { "objective" }
        register = { register }
        multiline = { false }
        ...
        { /*popup notification when no profile image selected */ } { /* ref :https://mui.com/material-ui/react-snackbar/ */ } <
