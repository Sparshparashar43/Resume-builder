    ...
    return ( <
        div > {
            windowSize.innerWidth > 850 ? ( <
                ...
                /> <
                ListItemText className = "IcoSpace"
                ...
                <
                MenuItem sx = { props.tab === 0 ? { color: "rgb(0, 128, 255)" } : null }
                onClick = {
                    () => {
                        handleClose();
                    }
                ...
                Divider / >
                <
                MenuItem sx = { props.tab === 1 ? { color: "rgb(0, 128, 255)" } : null }
                onClick = {
                    () => {
                        handleClose();
                    }
                ...
                Divider / >
                <
                MenuItem sx = { props.tab === 2 ? { color: "rgb(0, 128, 255)" } : null }
                onClick = {
                    () => {
                        handleClose();
                    }
                ...
                Divider / >
                <
                MenuItem sx = { props.tab === 3 ? { color: "rgb(0, 128, 255)" } : null }
                onClick = {
                    () => {
                        handleClose();
                    }
