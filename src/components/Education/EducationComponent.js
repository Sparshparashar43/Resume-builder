...
const EducationComponent = (props) => {
    ...
    return ( <
        Paper className = "education-paper"
        elevation = { 3 } >
        <
        ...
        /> <
        div > < /div> <
        InputComponent title = { "University" }
        type = { "text" }
        name = { "university" }
        register = { register }
        multiline = { false }
        ...
        /> <
        SelectComponent title = { "Start Year" }
        ...
        /> <
        /SelectComponent> <
        SelectComponent title = { "End Year" }
        ...
        Divider sx = {
            { margin: "10px 0px" } }
        /> <
        BackNextBtnComponent onNext = { handleNext }
        onBack = { handleBack }
        loading = { loading }
        tab = { props.tab }
        nextTitle = { "Next" }
